# this script is used to analyse the results of the 2023 simulation run after the optimization for the cost of land scenario
# file paths are relative to the root folder of the repository
...
# Battery capacities after optimization
...
# Getting capacities and locations for Dutch batteries
