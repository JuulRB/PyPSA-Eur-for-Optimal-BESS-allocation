# this script is used to analyse the results of the 2040 simulation run after the optimization for the COL scenario
...
# Plot network with line loading!
